...
<head lang="en">
    <meta charset="UTF-8">
    <title>Non-profits page</title>
    <link href="styles.css" rel="stylesheet" type="text/css">

</head>
<body>
<h2> Welcome to the Non-profits page</h2>
<form action="addchangenonprofits.php" method="post">
    <h2><input type="submit" name="Button" class = "frontbutton"value="Add"/></h2>
</form>
<form action="selectnonprofits.php" method="post">
